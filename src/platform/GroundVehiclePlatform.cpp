...
void
GroundVehiclePlatform::_clone(std::shared_ptr<Platform> p)
{
...
// *********************** //
void
GroundVehiclePlatform::doControlStep(int simFrequency_hz)
{
  ...
  mEngineForceCurrent += sgn(mEngineForceTarget - mEngineForceCurrent) * 0.0001;
...
void
GroundVehiclePlatform::setDestination(glm::dvec3 dest)
{
...
void
GroundVehiclePlatform::prepareSimulation(int simFrequency_hz)
{
