...
public:
   ...
   */
  virtual void applySettings(std::shared_ptr<PlatformSettings> settings,
                             bool manual);
  /**
   ...
   */
  inline Rotation getAttitude() const { return this->attitude; }
  /**
   ...
   * separately.
   */
  virtual Rotation getDirectionalAttitude() { return this->attitude; }
  /**
   ...
   */
  inline glm::dvec3 getVectorToTarget() const { return cached_vectorToTarget; }
   ...
   */
  virtual inline void getRollPitchYaw(double& roll, double& pitch, double& yaw)
  {
