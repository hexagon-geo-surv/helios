...
public:
   ...
   */
  void calcRaysNumber(size_t const idx) override { scanDev.calcRaysNumber(); }
  /**
   ...
   * @see Scanner::getBt2
   */
  double getBt2(size_t const idx) const override { return scanDev.cached_Bt2; }
  /**
   * @see Scanner::setBt2
   */
   ...
   * @see Scanner::getDr2
   */
  double getDr2(size_t const idx) const override { return scanDev.cached_Dr2; }
  /**
   * @see Scanner::setDr2
   */
   ...
   */
  void setReceivedEnergyMin(double const receivedEnergyMin_W,
                            size_t const idx) override
  {
