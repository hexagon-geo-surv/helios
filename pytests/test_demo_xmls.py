...
@pytest.mark.parametrize(
    ...
    [pytest.param((Path(WORKING_DIR) / 'data' / 'surveys' / 'demo' / 'als_hd_demo_tiff.xml'),
     ...
     pytest.param((Path(WORKING_DIR) / 'data' / 'surveys' / 'demo' / 'tls_arbaro_demo_alt_with_res.xml'),
                  id="tls_arbaro_demo_alt_with_res.xml"),
     ...
     pytest.param((Path(WORKING_DIR) / 'data' / 'surveys' / 'toyblocks' / 'livox_test.xml'),
                  id="livox_test.xml"),
